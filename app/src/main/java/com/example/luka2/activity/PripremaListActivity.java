    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            ...
            case R.id.priprema_preferences:
                startActivity(new Intent(PripremaListActivity.this, PripremaPreferences.class));
                break;
        }
